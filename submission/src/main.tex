...
\begin{IEEEkeywords}
Udacity, ROS, Localization, Navigation Stack, AMCL.
\end{IEEEkeywords}}
...
\begin{figure}[thpb]
      \centering
      \subfloat[Benchmark Model]{\includegraphics[width=0.45\linewidth]{result-drift-away}\label{fig:result-drift-away}}
      \hfill
      \subfloat[Personal Model]{\includegraphics[width=0.45\linewidth]{result-following-path}\label{fig:result-following-path}}
      \vfill
      \subfloat[Benchmark Model]{\includegraphics[width=0.45\linewidth]{result-corner}\label{fig:result-corner}}
      \hfill
      \subfloat[Personal Model]{\includegraphics[width=0.45\linewidth]{result-goal}\label{fig:result-goal}}
